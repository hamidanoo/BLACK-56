let handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  // Define the content
  let mainImg = "https://replicate.delivery/pbxt/CJyMWxJtxTL2O5nFrc3askbFihaLccVBBahyVdFpEV4RElcE/out..jpg"; // Main image URL
  let smallImg = "https://replicate.delivery/pbxt/CJyMWxJtxTL2O5nFrc3askbFihaLccVBBahyVdFpEV4RElcE/out..jpg"; // Small image URL
  let smallText = "I'M Alive Now"; // Small text
  let mainText = "BLACK"; // Main text
  ...
  let doc = {
    ...
    contextInfo: {
      ...
      externalAdReply: {
        ...
        sourceUrl: 'https://github.com/hamidanoo/BLACK-56',
        mediaType: 1,
